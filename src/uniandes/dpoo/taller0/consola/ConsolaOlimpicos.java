...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("2. Consultar el pais del atleta");
	...
	private void ejecutarPaisDelAtleta() {
		...
		System.out.println("\n"+"Pedir nombre de atleta"+"\n");
		
		String nombre = input("Por favor escriba el nombre del atleta: ");
		
		Atleta nombreAtleta = calculadora.buscarAtleta(nombre); 
		Pais nombrePais = nombreAtleta.darPais();
